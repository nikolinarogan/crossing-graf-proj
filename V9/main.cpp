...
int main(void)
{
    ...
    float cubeVertices[] = {
        // Front face
        -0.05f, -0.05f,  0.05f,  1.0f, 0.5f, 0.0f, 1.0f,  // Orange
         0.05f, -0.05f,  0.05f,  1.0f, 0.5f, 0.0f, 1.0f,
         0.05f,  0.05f,  0.05f,  1.0f, 0.5f, 0.0f, 1.0f,
        -0.05f, -0.05f,  0.05f,  1.0f, 0.5f, 0.0f, 1.0f,
         0.05f,  0.05f,  0.05f,  1.0f, 0.5f, 0.0f, 1.0f,
        -0.05f,  0.05f,  0.05f,  1.0f, 0.5f, 0.0f, 1.0f,
    ...
    float peoplePositions[6][3] = { //Ovo mi je matrica 6x3 i svaki red predstavlja pocetnu poz za neku kocku
        // Left edge cube (X, Y, Z) KRECU SE UDESNO
        {-3.5f, 0.1f, -1.5f},  
        {-3.5f, 0.2f, -1.0f},  
        {-3.5f, 0.15f, -0.5f}, 
        
        // Right edge cube (X, Y, Z) KRECU SE ULIJEVO
        {3.5f, 0.12f, 1.5f},   
        {3.5f, 0.18f, 1.0f},   
        {3.5f, 0.14f, 0.5f}    
    };
